...
public class XbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String CLASS_NAME = "MonitoringHost";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String DESCRIPTION = "监测主机";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String AUTHOR = "Chenchao";
     ...
     * 下方请根据需要修改
     */
    private static final String TABLE_PRE = "t_biz_indoor_";
     ...
     * （下方包路径拼接使用）
     */
    private static final String MODULE = "indoor.basedata";
     ...
     * 路径前缀
     */
    private static final String SYS_PATH = System.getProperty("user.dir") + "/xboot-fast/src/main/java/";

    // E:\windows\software\code_space\sts_space\demos\xboot-master\xboot-fast
    // E:\windows\software\code_space\sts_space\demos\xboot-master\
    /**
     * 运行该主函数即可生成代码
     * @param args
     * @throws IOException
